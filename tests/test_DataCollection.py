...
class Test_DataCollection(unittest.TestCase):
    ...
    myInstance = 0 
    def setUp(self):
        self.myInstance = DataCollection(instance=self.myInstanceNumber, interval_ms=self.myInterval, callback=self.sample)
    ...
    # def test_capMeasurementsSize(self): create span argument to datacollection
